...
##
*/
(function(){chrome.runtime.onMessage.addListener(function(a,b,c){"set-messages"===a.message?document.dispatchEvent(new CustomEvent("efyt-set-messages",{detail:JSON.stringify({messages:a.messages})})):"command"===a.message?document.dispatchEvent(new CustomEvent("efyt-command",{detail:JSON.stringify({command:a.command,control:a.control})})):"pause-video"===a.message?document.dispatchEvent(new Event("efyt-pause-video")):"preference-changed"===a.message&&document.dispatchEvent(new CustomEvent("efyt-preference-changed",
